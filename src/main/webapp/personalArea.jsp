...
<html>
<head>
    <title>Shopin A Ecommerce Category Flat Bootstrap Responsive Website Template | Personal area :: w3layouts</title>
...
<div class="banner-top">
    <div class="container">
        <h1>Personal area</h1>
        <em></em>
        <h2><a href="index.html">Home</a><label>/</label>Personal area</h2>
    </div>
</div>
<div class="single">
    <div class="container">
        <div class="col-md-9">
            <div class="col-md-5 grid">
                <div class="flexslider">
                    <ul class="slides">
                        <li data-thumb="">
                            <div class="thumb-image"><img src="avatar"
                                                          data-imagezoom="true"
            ...
            <div class="col-md-7 single-top-in">
                <div class="span_2_of_a1 simpleCart_shelfItem">
                    <h3>Hello ${sessionScope.user.firstName}!</h3>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="clearfix"></div>
