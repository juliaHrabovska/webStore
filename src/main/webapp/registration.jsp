    ...
    <div class="login">
        <form name="form" action="registration" method="post" onsubmit='return validate()'
            ...
            <div class="col-md-6 login-do">
                <div>
                    <div id="firstName" class="login-mail">
                        <input type="text" name="firstName" placeholder="First name"
                               value="${sessionScope.registerForm.firstName}">
                        <i class="glyphicon glyphicon-user"></i>
                    </div>

                    <div class="error-block">
                        <span style="margin:0" id='firstNameMessage'>${sessionScope.errors.firstName}</span>
                    </div>
                </div>
                <div id="secondName" class="login-mail">
                    <input type="text" name="secondName" placeholder="Second name"
                           value="${sessionScope.registerForm.secondName}">
                    <i class="glyphicon glyphicon-user"></i>
                </div>
                <div class="error-block">
                    <span style="margin:0" id='secondNameMessage'>${sessionScope.errors.secondName}</span>
                </div>
                <div id="email" class="login-mail">
                    <input type="text" name="email" placeholder="Email"
                           value="${sessionScope.registerForm.email}">
                    <i class="glyphicon glyphicon-envelope"></i>
                </div>
                <div class="error-block">
                    <span style="margin:0" id='emailMessage'>${sessionScope.errors.email}</span>
                </div>
                <div id="password" class="login-mail">
                    <input type="password" name="password" placeholder="Password">
                    <i class="glyphicon glyphicon-lock"></i>
                </div>
                <div class="error-block">
                    <span style="margin:0" id='passwordMessage'>${sessionScope.errors.password}</span>
                </div>
                <div id="passwordConfirm" class="login-mail">
                    <input type="password" name="passwordConfirm" placeholder="Password">
                    <i class="glyphicon glyphicon-lock"></i>
                </div>
                <div class="error-block">
                    <span style="margin:0" id='passwordConfirmMessage'>${sessionScope.errors.passwordConform}</span>
                </div>

                <div class="login-mail">
                    <h3 class="header-checkbox">Would you like to receive a newsletter</h3>
                    <h3 class="header-checkbox">Would you like to receive a newsletter</h3>
                    <a class="news-letter " href="#">
                        <label class="checkbox1"><input type="checkbox" name="desiredList" value="yes"
                        ${sessionScope.registerForm.desiredList == true ? 'checked' : ''}>
                            <i> </i>Yes</label>
                    </a>
                </div>
                ...
                <br>
                <div id="img-block" class="login-mail">
                    <img id='avatar-temp' src="images/noavatar.png" width='200' height='200'/>
                    <input id="i_file" type="file" name="avatar" accept="image/jpeg,image/png,image/gif"
                           style="display: none;">
                    <label class="hvr-skew-backward">
                        <input id="btn-upload" type="submit" value="Load image">
                    </label>
                </div>
                <br>
                <label class="hvr-skew-backward">
                    <input id="registration" type="submit" value="Submit">
                </label>
...
<!-- validation -->
<script src="js/validation/registrationValidateJS.js"></script>
